-- tests/test_hoverfloat.lua - Comprehensive Unit Tests
...
local function setup_test_environment()
  -- Clear any loaded hoverfloat modules
  ...
  _G.vim = {
    ...
    lsp = {
      ...
      util = {
        ...
        make_position_params = function() return {
